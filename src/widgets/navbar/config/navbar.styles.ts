...
const createNavbarTheme = (theme: typeof themeLight) => ({
    ...
    logo_hidden: "hidden md:block",

    desktop_menu: "hidden md:flex space-x-6 items-center gap-4",
    ...
    mobile_wrapper: "md:hidden flex items-center justify-between w-full px-2",
    mobile_inner: "flex items-center gap-2",
